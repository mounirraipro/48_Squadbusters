...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Squad Busters puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Squad Busters categories'],
  alternates: {
