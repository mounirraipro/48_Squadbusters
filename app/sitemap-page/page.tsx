...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Squad Busters. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Squad Busters sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Squad Busters' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Squad Busters?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Squad Busters.</p>
                </div>
            </div>
