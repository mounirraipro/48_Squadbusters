...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Squad Busters',
        url: 'https://squadbusters.online/about',
        description: 'Learn about Squad Busters, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Squad Busters',
...
export const metadata: Metadata = {
    title: 'About Us – Squad Busters',
    description: 'Learn about Squad Busters, our mission, and the team behind the game.',
    keywords: ['about Squad Busters', 'game team', 'who made Squad Busters'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Squad Busters</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Squad Busters was born from a simple idea: what if playing Squad Busters could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Squad Busters with a clear vision — to create a free, accessible, and
                    ...
                    Squad Busters has something for you.
                </p>
                ...
                <p>
                    Every level in Squad Busters is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Squad Busters offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Squad Busters better for
                    everyone.
                </p>
            </div>
        </>
