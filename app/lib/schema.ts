...
const SITE_URL = 'https://squadbusters.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Squad Busters',
        url: SITE_URL,
        description: 'Play Squad Busters free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Squad Busters online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
