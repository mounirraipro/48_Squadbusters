...
const SUPPORT_EMAIL = 'hello@squadbusters.online';

export const metadata: Metadata = {
    title: 'Contact Squad Busters',
    description: 'Get in touch with the Squad Busters team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Squad Busters', 'Squad Busters support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
