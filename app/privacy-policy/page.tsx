...
export const metadata: Metadata = {
    ...
    description: 'Read the Squad Busters Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Squad Busters privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Squad Busters, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Squad Busters, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Squad Busters is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@squadbusters.online</strong>.
                </p>
            </div>
        </>
    );
