...
export const metadata: Metadata = {
    ...
    description: 'Squad Busters is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Squad Busters accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Squad Busters accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Squad Busters is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Squad Busters presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Squad Busters. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@squadbusters.online</strong></li>
                </ul>
                <p>
