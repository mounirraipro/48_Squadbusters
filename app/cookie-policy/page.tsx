...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Squad Busters uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Squad Busters cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Squad Busters uses them, and how you can
                ...
                <p>Squad Busters uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Squad Busters.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@squadbusters.online</strong>.
                </p>
            </div>
        </>
    );
